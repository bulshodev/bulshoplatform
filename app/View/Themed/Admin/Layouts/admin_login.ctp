...
<body id="login-body">
    ...
    <div id="login">
        <div class="alert alert-info">
            ...
            <strong>Skype:</strong> <span>stephen.ngethe<span><br>
                    <strong>Email:</strong> <span>info@bulshosports.africa</span><br>
                    <strong>Mobile:</strong> <span>+254720310021 Mobile|Viber|Whatsapp</span>
        </div>
