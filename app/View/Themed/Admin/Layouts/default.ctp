...
<head>
    ...
    <?php if (in_array($this->Language->getLanguage(), array('fas', 'heb'))) : ?>
        <link rel="stylesheet" type="text/css" href="<?= $this->Html->url('/theme/Admin/assets/bootstrap-rtl/css/bootstrap-rtl.min.css?'); ?>" />
        <link rel="stylesheet" type="text/css" href="<?= $this->Html->url('/theme/Admin/assets/bootstrap-rtl/css/bootstrap-responsive-rtl.min.css?'); ?>" />
        <link rel="stylesheet" type="text/css" href="<?= $this->Html->url('/theme/Admin/css-rtl/style.css?'); ?>" />
        <link rel="stylesheet" type="text/css" href="<?= $this->Html->url('/theme/Admin/css-rtl/style_responsive.css?'); ?>" />
        <link rel="stylesheet" type="text/css" href="<?= $this->Html->url('/theme/Admin/css-rtl/style_gray.css?'); ?>" />
    <?php else : ?>
        <link rel="stylesheet" type="text/css" href="<?= $this->Html->url('/theme/Admin/assets/bootstrap/css/bootstrap.min.css?'); ?>" />
        <link rel="stylesheet" type="text/css" href="<?= $this->Html->url('/theme/Admin/assets/bootstrap/css/bootstrap-responsive.min.css?'); ?>" />
    ...
    <link href="/theme/Admin/assets/bootstrap-toggle-buttons/static/stylesheets/bootstrap-toggle-buttons.css" rel="stylesheet" type="text/css" />
...
<body class="fixed-top">
                ...
                <div class="top-nav ">
                    <ul class="nav pull-right top-menu">
                        ...
                        <?php if (CakeSession::read('Auth.User.group_id') == Group::OPERATOR_GROUP) : ?>
                            <li>
                                <a target="_blank" href="<?php echo $this->Html->url(array('admin' => false, 'language' => $this->language->getLanguage(), 'plugin' => null, 'controller' => 'users', 'action' => 'operator_panel')); ?>">
    ...
    <!-- BEGIN FOOTER -->
    <div id="footer">
        The platform is created and powered by bulshosports.africa
    </div>
    <!-- END FOOTER -->
    <!-- BEGIN JAVASCRIPTS -->
