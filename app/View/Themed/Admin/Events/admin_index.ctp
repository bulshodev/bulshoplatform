...
//                                                                    var_dump($field[$model]); exit;
                                                                    foreach ($field[$model] as $key => $var) {
                                                                        if ($key != 'locale') {
                                                                            ...
                                                                            if ($key == 'order') {
                                                                                ...
                                                                                if($key == 'active') {
                                                                                    echo sprintf('<input data-id="%d" name="active[]" type="checkbox" %s>', $field[$model]['id'],$t == 0 ? '' : 'checked="checked"');
                                                                                } else {
                                                                                    echo $t;
                                                                                }
                                                                            }
                                            ...
                                            <script type="text/javascript">
                                                $(document).ready(function() {
                                                    var update = "<?php echo $this->Html->url(array('language' => Configure::read('Config.language'), 'action' => 'edit'));?>";

                                                    $('input[name="active[]"]').change(function() {
                                                        $.post( update + '/' + $(this).attr('data-id'), { '<?=$model;?>' : { id : $(this).attr('data-id'), active: $(this).is(':checked') ? 1 : 0 } } );
                                                    });
                                                });
                                            </script>
                                        <?php else: ?>
