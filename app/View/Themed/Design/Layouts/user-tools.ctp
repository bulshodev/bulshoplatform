            ...
            <div class="sidebar">
                <div class="blue-box">
                    <div class="blue-in">
                        ...
                        <div class="white-in">
                            <ul>
                                <li><i class="ico icon-contact"></i><strong><?php echo __("Skype us"); ?></strong><br /><span class="reverse">http://bulshosports.africa/</span>
                                    <div class="clear"></div>
                                </li>
                                <li><i class="ico icon-faq"></i><strong><?php echo __("Call us"); ?></strong><br /><span class="reverse">070000XXX</span>
                                    <div class="clear"></div>
                                </li>
                                <li><i class="ico icon-call"></i><strong><?php echo __("Contact us by mail"); ?></strong><br /><a href="http://bulshosports.africa/#contacts" target="_blank"">Email us</a><div class=" clear">
                        </div>
                        </li>
                        <li><i class="ico icon-other"></i><strong><?php echo __("Other contacts"); ?></strong><br /><a href="http://bulshosports.africa/#contacts" target="_blank"">Contacts</a><div class=" clear">
                    </div>
                    </li>
                    </ul>
                </div>
