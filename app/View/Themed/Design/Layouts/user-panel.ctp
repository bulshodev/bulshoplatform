            ...
            <div class="blue-box">
                <ul class="faq-list">
                    ...
                    <?php if($this->MyHtml->checkAcl(array('plugin' => 'poker', 'controller' => 'pokerlogs', 'action' => 'index'))): ?>
                        <li>
                            <?php $class = (in_array($this->params['action'], array('pokerlogs'))) ? 'icon-faq11 active' : 'icon-faq11'; ?>
                            <?php echo $this->MyHtml->link(__('Poker log'), array('language' => Configure::read('Config.language'), 'plugin' => 'poker', 'controller' => 'PokerLogs', 'action' => 'index'), array('class' => $class)); ?>
                        </li>
                    <?php endif; ?>
